        ...
        for (const { name, lat, lon, country, state } of locations) {
          ...
          searchItem.innerHTML = `
                    <span class="m-icon">location_on</span>
                            ...
                            <div>
                                <p class="label-2 item-title">${name}</p>
                ...
                <h2 class="title-2" id="highlights-label">Todays Highlights</h2>
                        ...
                        <div class="highlight-list">
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <div class="wrapper">
                                    <span class="m-icon">humadity_percentage</span>
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy" title="${description}" alt="${description}" class="weather-icon">
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        height="48" loading="lazy" title="" alt="direction"
                         class="weather-icon" style="transform: rotate(${windDirection - 
                            180}deg)">
